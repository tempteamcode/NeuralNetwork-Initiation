...
class LeNet(torch.nn.Module):
	def __init__(self):
		...
		self.conv1 = torch.nn.Conv2d(3, 4, 6, 1)
		self.conv2 = torch.nn.Conv2d(4, 8, 4, 1)
		self.fc1 = torch.nn.Linear(57600//200, 36)
		self.fc2 = torch.nn.Linear(36, 9)
